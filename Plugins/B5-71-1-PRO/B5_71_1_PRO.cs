...
namespace B5_71_1_PRO
{
    ...
    public class OpertionFirsVerf : B5_71_PRO_Abstract.OpertionFirsVerf
    {
        public OpertionFirsVerf(ServicePack servicePack) : base(servicePack)
        {
            ...
            {
                new Device {Devices = new IDeviceRemote[] {new N3303A() }, Description = "Электронная нагрузка"},
            ...
            TestDevices = new IDeviceUi[] {new Device {Devices = new IDeviceRemote[] { new B571Pro1() }, Description = "источник питания"}};
