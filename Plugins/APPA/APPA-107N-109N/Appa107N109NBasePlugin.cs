    ...
    public abstract class OpertionFirsVerf : ASMC.Core.Model.Operation
    {
                ...
                foreach (var point in VoltPoint)
                {
                    ...
                    operation.BodyWorkAsync = () =>
                    {
                        try
                        {
                            ...
                            operation.Expected = new MeasPoint<Voltage, Frequency>(point.MainPhysicalQuantity.Value, point.MainPhysicalQuantity.Multiplier, new Frequency
                            {
                                Value = point.AdditionalPhysicalQuantity.Value,
                                Multiplier = point.AdditionalPhysicalQuantity.Multiplier
                            });

                            //расчет погрешности для конкретной точки предела измерения
                            ConstructTooleranceFormula(new MeasPoint<Frequency>(point.AdditionalPhysicalQuantity.Value, point.AdditionalPhysicalQuantity.Multiplier)); // функция подбирает коэффициенты для формулы погрешности
                            operation.ErrorCalculation = (inA, inB) =>
                                {
        ...
        public class Ope4_1_AcV_20mV_Measure : Oper4AcvMeasureBase
        {
                ...
                base(userItemOperation, inResourceDir)
            {
                ...
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>(4 * VoltMultiplier,  UnitMultiplier.Mili, new Frequency { Value = 40 }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>(4 * VoltMultiplier,  UnitMultiplier.Mili, new Frequency { Value = 1000 }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>(10 * VoltMultiplier, UnitMultiplier.Mili, new Frequency { Value = 40 }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>(10 * VoltMultiplier, UnitMultiplier.Mili, new Frequency { Value = 1000 }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>(18 * VoltMultiplier, UnitMultiplier.Mili, new Frequency { Value = 40 }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>(18 * VoltMultiplier, UnitMultiplier.Mili, new Frequency { Value = 1000 }));
            }
        ...
        public class Ope4_1_AcV_2V_Measure : Oper4AcvMeasureBase
        {
                ...
                base(userItemOperation, inResourceDir)
            {
                ...
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)0.2,  new Frequency { Value = 40 * VoltMultiplier }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)0.2, new Frequency { Value = 1000 * VoltMultiplier }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)0.2, new Frequency { Value = 10 * VoltMultiplier, Multiplier = UnitMultiplier.Kilo }));
                VoltPoint.Add(new MeasPoint<Voltage, Frequency>((decimal)0.2, new Frequency { Value = 20 * VoltMultiplier, Multiplier = UnitMultiplier.Kilo }));
                ...
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)1.8,  new Frequency { Value = 40 * VoltMultiplier }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)1.8,  new Frequency { Value = 1000 * VoltMultiplier }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)1.8,  new Frequency { Value = 10 * VoltMultiplier, Multiplier = UnitMultiplier.Kilo }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)1.8,  new Frequency { Value = 20 * VoltMultiplier, Multiplier = UnitMultiplier.Kilo }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)1.8,  new Frequency { Value = 50 * VoltMultiplier, Multiplier = UnitMultiplier.Kilo }));
                VoltPoint.Add(new MeasPoint<Voltage,Frequency>((decimal)1.8,  new Frequency { Value = 100 * VoltMultiplier, Multiplier = UnitMultiplier.Kilo }));
            }
        ...
        public class Ope4_1_AcV_200V_Measure : Oper4AcvMeasureBase
        {
                ...
                base(userItemOperation, inResourceDir)
            {
                ...
                //VoltPoint[2] = new AcVariablePoint((decimal)1.8 * VoltMultiplier, thisRangeUnits.Units, thisRangeUnits.Multiplier, HerzVPoint, true);
                ...
                foreach (var currPoint in CurrentDciPoint)
                {
                    ...
                    operation.BodyWorkAsync = () =>
                    {
                        ...
                        MathStatistics.Round(ref measurePoint, mantisa);
                            ...
                            operation.Getting =
                                new MeasPoint<Current>(measurePoint, thisRangeUnits.MainPhysicalQuantity.Multiplier);
                            operation.Expected = currPoint;
                        //расчет погрешности для конкретной точки предела измерения
                        operation.ErrorCalculation = (inA, inB) =>
                            {
                                    ...
                                    MathStatistics.GetMantissa((decimal)(RangeResolution
                                                                         ...
                                                                         .GetDoubleValue() *
                                                                          ...
                                                                          currPoint.MainPhysicalQuantity.Multiplier
                                                                                   .GetDoubleValue()));
                                MathStatistics.Round(ref result, mantisa);
                                return new MeasPoint<Current>(result, thisRangeUnits.MainPhysicalQuantity.Multiplier);
                            };

                            operation.LowerTolerance = new MeasPoint<Current>(operation.Expected.MainPhysicalQuantity.Value - operation.Error.MainPhysicalQuantity.Value, thisRangeUnits.MainPhysicalQuantity.Multiplier);

                            operation.UpperTolerance = new MeasPoint<Current>(operation.Expected.MainPhysicalQuantity.Value + operation.Error.MainPhysicalQuantity.Value, thisRangeUnits.MainPhysicalQuantity.Multiplier);
                            ...
                            operation.IsGood = () =>
                            {
                                ...
                                return (operation.Getting.MainPhysicalQuantity.Value < operation.UpperTolerance.MainPhysicalQuantity.Value) &
                                       (operation.Getting.MainPhysicalQuantity.Value > operation.LowerTolerance.MainPhysicalQuantity.Value);
                                ;
                            };
                        }
                        catch (Exception e)
        ...
        public class Oper5_1Dci_20mA_Measure : Oper5DciMeasureBase
        {
                ...
                base(userItemOperation, inResourceDir)
            {
                ...
                thisRangeUnits = new MeasPoint<Current>(0, UnitMultiplier.Mili);

                BaseMultiplier = 1;
                CurrentDciPoint = new MeasPoint<Current>[5];
                CurrentDciPoint[0] =
                    new MeasPoint<Current>(4 * BaseMultiplier, thisRangeUnits.MainPhysicalQuantity.Multiplier);
                CurrentDciPoint[1] =
                    new MeasPoint<Current>(8 * BaseMultiplier, thisRangeUnits.MainPhysicalQuantity.Multiplier );
                CurrentDciPoint[2] =
                    new MeasPoint<Current>(12 * BaseMultiplier, thisRangeUnits.MainPhysicalQuantity.Multiplier );
                CurrentDciPoint[3] =
                    new MeasPoint<Current>(18 * BaseMultiplier, thisRangeUnits.MainPhysicalQuantity.Multiplier );
                CurrentDciPoint[4] =
                    new MeasPoint<Current>(-18 * BaseMultiplier, thisRangeUnits.MainPhysicalQuantity.Multiplier );
            }
        ...
        public class Oper5_1Dci_200mA_Measure : Oper5DciMeasureBase
        {
                ...
                : base(userItemOperation, inResourceDir)
            {
                ...
                BaseMultiplier = 10;
                CurrentDciPoint = new MeasPoint<Current>[5];
                CurrentDciPoint[0] = new MeasPoint<Current>(4 * BaseMultiplier  , thisRangeUnits.MainPhysicalQuantity.Multiplier);
                CurrentDciPoint[1] = new MeasPoint<Current>(8 * BaseMultiplier  , thisRangeUnits.MainPhysicalQuantity.Multiplier);
                CurrentDciPoint[2] = new MeasPoint<Current>(12 * BaseMultiplier , thisRangeUnits.MainPhysicalQuantity.Multiplier);
                CurrentDciPoint[3] = new MeasPoint<Current>(18 * BaseMultiplier , thisRangeUnits.MainPhysicalQuantity.Multiplier);
                CurrentDciPoint[4] = new MeasPoint<Current>(-18 * BaseMultiplier, thisRangeUnits.MainPhysicalQuantity.Multiplier);
            }
        ...
        public class Oper5_1Dci_2A_Measure : Oper5DciMeasureBase
        {
                ...
                base(userItemOperation, inResourceDir)
            {
                ...
                thisRangeUnits = new MeasPoint<Current>(0);
        ...
        public class Oper6AciMeasureBase : ParagraphBase<AcVariablePoint>
        {
            ...
            protected void ConstructTooleranceFormula(MeasPoint inFreq)
            {
                if (OperationRangeNominal == Mult107_109N.RangeNominal.Range20mA &&
                    inFreq.Multiplier == UnitMultiplier.None)
                {
                        ...
                        operation.BodyWorkAsync = () =>
                        {
                            try
                            {
                                ...
                                operation.Expected = new AcVariablePoint(curr.MainPhysicalQuantity.Value,
                                                                         thisRangeUnits.Units, thisRangeUnits.Multiplier,
                                                                         new[] { freqPoint });
                            ...
                            operation.ErrorCalculation = (inA, inB) =>
                                {
                                    ...
                                    MathStatistics.Round(ref result, mantisa);
                                    return new AcVariablePoint(result, thisRangeUnits.Units, thisRangeUnits.Multiplier);
                                };
                            ...
                            MathStatistics.Round(ref measurePoint, mantisa);
                                ...
                                operation.Getting =
                                    new AcVariablePoint(measurePoint, thisRangeUnits.Units, thisRangeUnits.Multiplier);
                            }
                            catch (Exception e)
                            {
                                Logger.Error(e);
            ...
            private void TolleranceConstruct(MeasPoint freqPoint)
            {
                ...
                var realFreq = freqPoint.Value * (decimal)freqPoint.Multiplier.GetDoubleValue();
                if (OperationRangeNominal == Mult107_109N.RangeNominal.Range20mA)
                {
        ...
        public class Oper6_1Aci_20mA_Measure : Oper6AciMeasureBase
        {
                ...
                IUserItemOperation userItemOperation, string inResourceDir) : base(userItemOperation, inResourceDir)
            {
                ...
                AciPoint[0] = new AcVariablePoint(4 * CurrentMultiplier, thisRangeUnits.Units,
                                                  thisRangeUnits.Multiplier, HerzPoint);
                AciPoint[1] = new AcVariablePoint(10 * CurrentMultiplier, thisRangeUnits.Units,
                                                  thisRangeUnits.Multiplier, HerzPoint);
                AciPoint[2] = new AcVariablePoint(18 * CurrentMultiplier, thisRangeUnits.Units,
                                                  thisRangeUnits.Multiplier, HerzPoint);
            }
        ...
        public class Oper8_1Resistance_2kOhm_Measure : Oper8ResistanceMeasureBase
        {
                ...
                IUserItemOperation userItemOperation, string inResourceDir) : base(userItemOperation, inResourceDir)
            {
                ...
                OhmPoint[0] = new MeasPoint(thisRangeUnits.Units, thisRangeUnits.Multiplier,
                                            (decimal)0.4 * BaseMultiplier);
                OhmPoint[1] = new MeasPoint(thisRangeUnits.Units, thisRangeUnits.Multiplier,
                                            (decimal)0.8 * BaseMultiplier);
                OhmPoint[2] = new MeasPoint(thisRangeUnits.Units, thisRangeUnits.Multiplier, 1 * BaseMultiplier);
                OhmPoint[3] = new MeasPoint(thisRangeUnits.Units, thisRangeUnits.Multiplier,
                                            (decimal)1.5 * BaseMultiplier);
                OhmPoint[4] = new MeasPoint(thisRangeUnits.Units, thisRangeUnits.Multiplier,
                                            (decimal)1.8 * BaseMultiplier);
            }
        ...
        public class Oper8_1Resistance_2GOhm_Measure : Oper8ResistanceMeasureBase
        {
                ...
                IUserItemOperation userItemOperation, string inResourceDir) : base(userItemOperation, inResourceDir)
            {
                ...
                OhmPoint[0] = new MeasPoint(thisRangeUnits.Units, thisRangeUnits.Multiplier, (decimal)0.9);
            }
