...
namespace APPA_107N_109N
{
    ...
    public abstract class OpertionFirsVerf : ASMC.Core.Model.Operation
    {
        ...
        public class Ope4_1_AcV_2V_Measure : Oper4AcvMeasureBase
        {
                ...
                base(userItemOperation, inResourceDir)
            {
                ...
                VoltPoint.Add(new MeasPoint<Voltage, Frequency>((decimal) 0.2,
                                                                new Frequency {Value = 40 * VoltMultiplier}));
                VoltPoint.Add(new MeasPoint<Voltage, Frequency>((decimal) 0.2,
                                                                new Frequency {Value = 1000 * VoltMultiplier}));
                VoltPoint.Add(new MeasPoint<Voltage, Frequency>((decimal) 0.2,
                                                                new Frequency
                                                                {
        ...
        public class Ope4_1_AcV_200V_Measure : Oper4AcvMeasureBase
        {
                ...
                base(userItemOperation, inResourceDir)
            {
                ...
                VoltPoint.Add(new MeasPoint<Voltage, Frequency>((decimal) 0.2 * VoltMultiplier,
                                                                new Frequency
                                                                {
                                                                    Value = 40, Multiplier = UnitMultiplier.None
                                                                })); //.IsFake = true;
                VoltPoint.Add(new MeasPoint<Voltage, Frequency>((decimal) 0.2 * VoltMultiplier,
                                                                new Frequency
        ...
        public class Oper6AciMeasureBase : ParagraphBase<MeasPoint<Current, Frequency>>
        {
                ...
                
                {
                    ...
                    operation.BodyWorkAsync = () =>
                    {
                        try
                        {
                            ...
                            {
                                decimal result = BaseTolCoeff * Math.Abs(operation.Expected.MainPhysicalQuantity.Value) +
                                             EdMlRaz *
                                             RangeResolution.MainPhysicalQuantity.Value *
                                             (decimal) (RangeResolution
                                                       .MainPhysicalQuantity.Multiplier.GetDoubleValue() /
                                ...
                                MathStatistics.Round(ref result, mantisa);
                                return new MeasPoint<Current,Frequency>(result,  curr.MainPhysicalQuantity.Multiplier, curr.AdditionalPhysicalQuantity);
                            };
            ...
            /// </summary>
            /// <returns>Результат вычисления.</returns>
            private void ConstructTooleranceFormula(MeasPoint<Current, Frequency> inPoint)
            {
                if (OperationRangeNominal == Mult107_109N.RangeNominal.Range20mA &&
                    inPoint.AdditionalPhysicalQuantity.Multiplier == UnitMultiplier.None)
                {
                    if (inPoint.AdditionalPhysicalQuantity.Value >= 40 &&
                        inPoint.AdditionalPhysicalQuantity.Value < 500)
                    {
                        BaseTolCoeff = (decimal) 0.008;
                        EdMlRaz = 50;
                    }

                    if (inPoint.AdditionalPhysicalQuantity.Value >= 500 &&
                        inPoint.AdditionalPhysicalQuantity.Value < 1000)
                    {
                         ...
                         OperationRangeNominal == Mult107_109N.RangeNominal.Range10A)
                {
                    ...
                    else if (inPoint.AdditionalPhysicalQuantity.Value >= 500 &&
                             inPoint.AdditionalPhysicalQuantity.Value < 1000)
                    {
                        BaseTolCoeff = (decimal) 0.012;
                        EdMlRaz = 80;
                    }
                    else if (inPoint.AdditionalPhysicalQuantity.Value >= 1000 &&
                             inPoint.AdditionalPhysicalQuantity.Value <= 3000)
                    {
                        BaseTolCoeff = (decimal) 0.02;
                        EdMlRaz = 80;
                    }
