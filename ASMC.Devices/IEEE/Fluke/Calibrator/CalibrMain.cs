            ...
            public class CSet
            {
                ...
                public class CVoltage
                {
                    ...
                    public class CDc :HelpDeviceBase
                    {
                        ...
                        public CalibrMain SetValue(decimal value, Multipliers mult = Data.Model.Multipliers.None)
                        {
                            _calibrMain.WriteLine($@"OUT {JoinValueMult(value, mult)}V, 0{ JoinValueMult((double)0, Data.Model.Multipliers.None)}HZ");
                    ...
                    public class CAc : HelpDeviceBase
                    {
                        ...
                        public CalibrMain SetValue(decimal value,decimal hertz, Multipliers voltMult, Multipliers herzMult = Data.Model.Multipliers.None)
                        {
