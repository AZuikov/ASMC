...
namespace ASMC.Core.UI
{
    ...
    //            if(ps > 0 && _sw.ElapsedMilliseconds - ps < TimeRemainingInterval)
    //                return;

    //            ps = _sw.ElapsedMilliseconds;
    //            window.PART_TimeRemaining.Text = GetTimeRemaining(e);
    //        });
    ...
    //    {
    //        var timeString = LocalizationManager.Default["ProgressService_TimeRemainingCalculating"];
    ...
    //        if(duration.Hours > 0)
    //            timeString = string.Format(LocalizationManager.Default["ProgressService_TimeRemainingFormat1"],
    //                duration.Hours, duration.Minutes);
    //        else if(duration.Minutes > 0)
    //            timeString = string.Format(LocalizationManager.Default["ProgressService_TimeRemainingFormat2"],
    //                duration.Minutes);
    //        else
    //            timeString = string.Format(LocalizationManager.Default["ProgressService_TimeRemainingFormat3"],
    //                duration.Seconds);
