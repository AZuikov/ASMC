...
namespace ASMC.Core
{
    ...
    public string ConnectionString
    {
        get
        {
            ...
            return
                $"Provider=sqloledb;Data Source={_server};Initial Catalog={_source}{iss};User Id={_user};Password={Password}";
        }
    }
        ...
        try
        {
            ...
            if (dataTable.PrimaryKey.Any())
            {
                ...
                throw new InvalidOperationException(string.Format(
                    "Обновление данных невозможно. Таблица с названием '{0}' не содержит первичного ключа.",
                    tableName));
